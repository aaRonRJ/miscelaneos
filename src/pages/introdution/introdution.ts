...
@Component({
  selector: 'page-introdution',
  templateUrl: 'introdution.html',
})
export class IntrodutionPage {
  slides: any[] = [
    {
      title: "Bienvenido!!!",
  ...
  constructor(public navCtrl: NavController,
              private storageProvider: SettingsProvider) {}

  skipTutorial() {
    this.storageProvider.settings.showTutorial = false;
    this.storageProvider.saveStorage();
